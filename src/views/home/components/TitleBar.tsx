...
export default function TitleBar({ tab, onTabChanged }: Props) {
    ...
    return (
        <View style={styles.titleLayout}>
            ...
            <View style={styles.tabButton}>
                <TouchableOpacity style={styles.tabButton} onPress={() => { setTabIndex(0); onTabChanged?.(0) }}>
            ...
            <View style={styles.tabButton}>
                ...
                <TouchableOpacity style={styles.tabButton} onPress={() => { setTabIndex(1); onTabChanged?.(1) }}>
            ...
            <View style={styles.tabButton}>
                ...
                <TouchableOpacity style={styles.tabButton} onPress={() => { setTabIndex(2); onTabChanged?.(2) }}>
